...
export default function QuotationFilters({ selectedStatuses, setSelectedStatuses, selectedCustomers, setSelectedCustomers, dateRange, setDateRange, resetPagination, customers = [] }) {
  ...
  // Get unique statuses — includes 'submitted' for backward compatibility with legacy data
  const uniqueStatuses = ['draft', 'sent', 'submitted', 'accepted', 'rejected', 'expired', 'converted'];
