...
export default function CompanySettingsComponent() {
  ...
  const loadSettings = async () => {
    try {
      ...
      if (settingsList.length > 0) {
        ...
        const loadedSettings = settingsList[0] as any;
        setSettings(prev => ({
          ...prev,
          ...loadedSettings,
  ...
  const handleSave = async () => {
    ...
    try {
      const settingsList = await CompanySettings.list();
      if (settingsList.length > 0) {
        await CompanySettings.update((settingsList[0] as any).id, settings);
      } else {
        ...
        <div className="space-y-4 pt-6 border-t">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border">
              ...
              <div className="text-xs text-gray-500 w-40">1 GBP = {Number(settings.fxGbpToAed ?? 4.85).toFixed(4)} AED</div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border">
              ...
              <div className="text-xs text-gray-500 w-40">1 USD = {Number(settings.fxUsdToAed ?? 3.6725).toFixed(4)} AED</div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border">
              ...
              <div className="text-xs text-gray-500 w-40">1 INR = {parseFloat(String(settings.fxInrToAed ?? 0.044)).toFixed(4)} AED</div>
            </div>
          </div>
        </div>
