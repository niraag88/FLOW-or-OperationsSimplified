              ...
              <tbody className="divide-y">
                {parsedRows.map((row: any, idx: any) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      <span className={row.errors.some((e: any) => e.includes("Brand")) ? "text-red-600 font-medium" : ""}>
                        {row.brandName || <span className="text-gray-400 italic">—</span>}
                      </span>
                    </td>
                    <td className="px-3 py-2 font-mono text-xs">
                      <span className={row.errors.some((e: any) => e.includes("code")) ? "text-red-600 font-medium" : ""}>
                        {row.productCode || <span className="text-gray-400 italic">—</span>}
                      </span>
                    </td>
                    <td className="px-3 py-2">
                      <span className={row.errors.some((e: any) => e.includes("name")) ? "text-red-600 font-medium" : ""}>
