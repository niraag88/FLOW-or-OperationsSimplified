...
import { Settings as SettingsIcon, Users, Building2, Package2, Database, HardDrive, Trash2 } from "lucide-react";
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <div className="w-full overflow-x-auto">
          <TabsList className="grid grid-cols-6 min-w-[520px] sm:min-w-0 sm:w-full">
